...
@property (nonatomic, strong) NSString * stop_desc;
@property (nonatomic, strong) NSString * stop_lat;
@property (nonatomic, strong) NSString * stop_lon;
@property (nonatomic, strong) NSString * zone_id;
@property (nonatomic, strong) NSString * stop_url;
@property (nonatomic, strong) NSString * location_type;
@property (nonatomic, strong) NSString * stop_timezone;
